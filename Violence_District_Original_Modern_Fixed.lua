...
-- =====================================================
-- MODERN UI LOADER (FIXED)
-- Keep the original ModernV2 UI, but load it reliably.
-- =====================================================
local ModernV2 = nil

local function KYS_LoadModernUI(url)
    ...
    if not fn then
        warn("[KYSHub] Modern UI compile error:", compileErr)
        return nil
    end
    ...
    warn("[KYSHub] Modern UI init error:", result)
    return nil
end

-- Prefer the same ModernLua implementation intended by the original script.
ModernV2 = KYS_LoadModernUI(
    "https://raw.githubusercontent.com/Kys-lol/KysHubNewUI/refs/heads/main/ModernLua.txt"
)

if not ModernV2 then
    ModernV2 = KYS_LoadModernUI(
        "https://raw.githubusercontent.com/Kys-lol/KysHubNewUI/refs/heads/main/MainV2.lua"
    )
end

if not ModernV2 then
    warn("[KYSHub] ModernV2 could not be loaded; main menu was not created.")
end
